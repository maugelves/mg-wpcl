...
class Logs extends \WP_List_Table {
    ...
    function get_columns() {
        ...
        return $columns = array(
            'id'            => __('ID', 'mgwpcl'),
            'description'   => __('Description', 'mgwpcl'),
            'date_created'  => __('Date Created', 'mgwpcl'),
            'user'          => __('User', 'mgwpcl'),
            'ip'            => __('IP', 'mgwpcl')
        );
        ...
        switch( $column_name ) {
            ...
            case 'user':
                ...
                if($user_info){
                    ...
                    echo "<a href='" . get_edit_user_link($item->user_id) . "'>" . $user_meta["first_name"][0] . " " . $user_meta["last_name"][0] . "<br>" . $user_info->data->user_email . "</a>";
                }
                break;
            case 'ip':
                echo $item->IP;
